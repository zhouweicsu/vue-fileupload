...
/***/ function(module, exports, __webpack_require__) {
	...
	_vue2["default"].component('fileupload', _fileupload2["default"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "_v-52d42847/fileupload.vue"
	  if (!module.hot.data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js?sourceMap!./../node_modules/vue-loader/lib/style-rewriter.js!./../node_modules/sass-loader/index.js!./fileupload.scss", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js?sourceMap!./../node_modules/vue-loader/lib/style-rewriter.js!./../node_modules/sass-loader/index.js!./fileupload.scss");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".upload-wrap label {\n  position: relative;\n  display: inline-block;\n  min-width: 200px;\n  font-size: 1.25rem;\n  font-weight: 700;\n  text-align: center;\n  text-overflow: ellipsis;\n  white-space: nowrap;\n  overflow: hidden;\n  padding: 0.625rem 0.75rem;\n  color: #f1e5e6;\n  background-color: #2196f3;\n  cursor: pointer; }\n  .upload-wrap label:hover {\n    background-color: #0c7cd5; }\n  .upload-wrap label .progress {\n    position: absolute;\n    top: 0;\n    left: 0;\n    height: 4px;\n    background: -webkit-linear-gradient(135deg, #fff 25%, #58a 0, #58a 50%, #fff 0, #fff 75%, #58a 0);\n    background: linear-gradient(-45deg, #fff 25%, #58a 0, #58a 50%, #fff 0, #fff 75%, #58a 0);\n    background-size: 16px 16px; }\n\n.upload-wrap input {\n  position: absolute;\n  width: 0;\n  height: 0;\n  opacity: 0;\n  z-index: -1; }\n\n.upload-wrap em {\n  line-height: 4em;\n  vertical-align: top;\n  display: inline-block;\n  font-style: normal;\n  font-size: 1.2em; }\n  .upload-wrap em.error {\n    color: #ef9b6d; }\n  .upload-wrap em.success {\n    color: #65c178; }\n", "", {"version":3,"sources":["/./src/fileupload.scss"],"names":[],"mappings":"AAAA;EACE,mBAAmB;EACnB,sBAAsB;EACtB,iBAAiB;EACjB,mBAAmB;EACnB,iBAAiB;EACjB,mBAAmB;EACnB,wBAAwB;EACxB,oBAAoB;EACpB,iBAAiB;EACjB,0BAA0B;EAC1B,eAAe;EACf,0BAA0B;EAC1B,gBAAgB,EAAE;EAClB;IACE,0BAA0B,EAAE;EAC9B;IACE,mBAAmB;IACnB,OAAO;IACP,QAAQ;IACR,YAAY;IACZ,kGAA0F;IAA1F,0FAA0F;IAC1F,2BAA2B,EAAE;;AAEjC;EACE,mBAAmB;EACnB,SAAS;EACT,UAAU;EACV,WAAW;EACX,YAAY,EAAE;;AAEhB;EACE,iBAAiB;EACjB,oBAAoB;EACpB,sBAAsB;EACtB,mBAAmB;EACnB,iBAAiB,EAAE;EACnB;IACE,eAAe,EAAE;EACnB;IACE,eAAe,EAAE","file":"fileupload.scss","sourcesContent":[".upload-wrap label {\n  position: relative;\n  display: inline-block;\n  min-width: 200px;\n  font-size: 1.25rem;\n  font-weight: 700;\n  text-align: center;\n  text-overflow: ellipsis;\n  white-space: nowrap;\n  overflow: hidden;\n  padding: 0.625rem 0.75rem;\n  color: #f1e5e6;\n  background-color: #2196f3;\n  cursor: pointer; }\n  .upload-wrap label:hover {\n    background-color: #0c7cd5; }\n  .upload-wrap label .progress {\n    position: absolute;\n    top: 0;\n    left: 0;\n    height: 4px;\n    background: linear-gradient(-45deg, #fff 25%, #58a 0, #58a 50%, #fff 0, #fff 75%, #58a 0);\n    background-size: 16px 16px; }\n\n.upload-wrap input {\n  position: absolute;\n  width: 0;\n  height: 0;\n  opacity: 0;\n  z-index: -1; }\n\n.upload-wrap em {\n  line-height: 4em;\n  vertical-align: top;\n  display: inline-block;\n  font-style: normal;\n  font-size: 1.2em; }\n  .upload-wrap em.error {\n    color: #ef9b6d; }\n  .upload-wrap em.success {\n    color: #65c178; }\n"],"sourceRoot":"webpack://"}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _START = 0,
	    ...
	    _FAILED = 3,
	    _REUPLOAD = 4;
	var stats = ['Choosing a file...', 'Uploading...', 'Success!', 'Failed!', 'Click to re-upload...'];
	                ...
	                this.$http.post(this.url, form, {
	                    ...
	                    progress: function progress(e) {
	                        if (e.lengthComputable) {
	                            _this.progress.loaded = e.loaded;
	                            _this.progress.max = e.total;
	                        }
	                    }
	                }).then(function (res) {
	                    if (res.status == 200) {
	                        var data = (0, _stringify2.default)(res.data);
	                        if (data.errno) {
	                            _this.statcode = _FAILED;
	                            _this.errmsg = data.errmsg;
	                        } else {
	                            _this.statcode = _SUCCESS;
	                            _this.successmsg = data.msg;
	                        }
	                    } else {
	                        _this.statcode = _FAILED;
	                        _this.errmsg = 'Upload error...';
	                    }
	                });
	            } else {
	                var me = this;
